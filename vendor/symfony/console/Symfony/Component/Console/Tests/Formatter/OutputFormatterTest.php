...
class OutputFormatterTest extends \PHPUnit_Framework_TestCase {
  ...
  public function testNestedStyles() {
    ...
    $this->assertEquals(
      "\033[37;41msome \033[0m\033[32msome info\033[0m\033[37;41m error\033[0m", $formatter->format('<error>some <info>some info</info> error</error>')
    );
  }
  ...
  public function testStyleEscaping() {
    ...
    $this->assertEquals(
      "(\033[32mz>=2.0,<a2.3\033[0m)", $formatter->format('(<info>' . $formatter->escape('z>=2.0,<a2.3') . '</info>)')
    );
  }
  ...
  public function testDeepNestedStyles() {
    ...
    $this->assertEquals(
      "\033[37;41merror\033[0m\033[32minfo\033[0m\033[33mcomment\033[0m\033[37;41merror\033[0m", $formatter->format('<error>error<info>info<comment>comment</info>error</error>')
    );
  }
