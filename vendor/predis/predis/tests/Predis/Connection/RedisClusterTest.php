...
class RedisClusterTest extends PredisTestCase {
  ...
  public function testCanAssignConnectionsToCustomSlots() {
    ...
    $expectedMap = array_merge(
      array_fill(0, 1365, '127.0.0.1:6379'), array_fill(1364, 1365, '127.0.0.1:6380'), array_fill(2729, 1366, '127.0.0.1:6381')
    );
  ...
  public function testRemovingConnectionResetsSlotsMap() {
    ...
    $expectedMap = array_merge(
      array_fill(0, 2048, '127.0.0.1:6379'), array_fill(2048, 2048, '127.0.0.1:6380')
    );
  ...
  public function testCanAssignConnectionsToCustomSlotsFromParameters() {
    ...
    $expectedMap = array_merge(
      array_fill(0, 5461, '127.0.0.1:6379'), array_fill(5460, 5461, '127.0.0.1:6380'), array_fill(10921, 5462, '127.0.0.1:6381')
    );
