...
class PHPParser_Tests_Builder_ParamTest extends PHPUnit_Framework_TestCase {
    ...
    return array(
      ...
      array(
        ...
        new PHPParser_Node_Expr_Array(array(
          ...
          new PHPParser_Node_Expr_ArrayItem(
            new PHPParser_Node_Scalar_String('foo'), new PHPParser_Node_Scalar_String('bar')
          ),
          ))
      ),
      array(
  ...
  public function testTypeHints() {
    ...
    $this->assertEquals(
      new PHPParser_Node_Param('test', null, 'array'), $node
    );
    ...
    $this->assertEquals(
      new PHPParser_Node_Param('test', null, 'callable'), $node
    );
    ...
    $this->assertEquals(
      new PHPParser_Node_Param('test', null, new PHPParser_Node_Name('Some\Class')), $node
    );
  }
  ...
  public function testByRef() {
    ...
    $this->assertEquals(
      new PHPParser_Node_Param('test', null, null, true), $node
    );
  }
