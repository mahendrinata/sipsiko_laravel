 ...
 * @package Yay
 */
class Yay_Expectations_ExactlyExpectation extends Yay_Expectations_AbstractExpectation {
  ...
  public function describeSatisfaction(Yay_Description $description) {
    ...
    $description->appendText(
      sprintf(
        ' occurred %d times', (($this->_matched < $this->_count) ? $this->_matched : $this->_count)
    ));
  }
