 ...
 * @package Yay
 */
class Yay_Expectations_BetweenExpectation extends Yay_Expectations_AbstractExpectation {
  ...
  public function describeSatisfaction(Yay_Description $description) {
    ...
    $description->appendText(
      sprintf(
        ' occurred %d times', (($this->_matched < $this->_max) ? $this->_matched : $this->_max)
    ));
  }
