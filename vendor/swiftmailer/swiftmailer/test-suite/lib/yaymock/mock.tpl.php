...
<?php foreach ($methods as $method): ?>
  <?php echo $method['access']; ?> <?php echo $method['modifiers']; ?> function <?php if ($method['returnReference']) echo '&'; ?><?php echo $method['name']; ?>(<?php foreach ($method['parameters'] as $i => $param): ?>
    <?php if ($i > 0) echo ','; ?>
