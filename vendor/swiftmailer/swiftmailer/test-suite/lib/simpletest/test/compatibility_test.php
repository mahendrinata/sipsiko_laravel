...
class TestOfCompatibility extends UnitTestCase {
  ...
  function testIsA() {
    $this->assertTrue(SimpleTestCompatibility::isA(
        new ComparisonClass(), 'ComparisonClass'));
    $this->assertFalse(SimpleTestCompatibility::isA(
        new ComparisonClass(), 'ComparisonSubclass'));
    $this->assertTrue(SimpleTestCompatibility::isA(
        new ComparisonSubclass(), 'ComparisonClass'));
  }
  ...
  function testInteraceComparison() {
    ...
    $this->assertFalse(SimpleTestCompatibility::isA(
        new ComparisonClass(), 'ComparisonInterface'));
    $this->assertTrue(SimpleTestCompatibility::isA(
        new ComparisonClassWithInterface(), 'ComparisonInterface'));
  }
