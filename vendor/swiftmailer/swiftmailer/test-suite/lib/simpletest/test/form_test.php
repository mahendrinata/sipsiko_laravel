...
class TestOfForm extends UnitTestCase {
  ...
  function testEmptyAction() {
    ...
    $form = new SimpleForm($tag, $this->page('http://host/a/index.html'));
    $this->assertEqual(
      $form->getAction(), new SimpleUrl('http://host/a/index.html'));
  }
  ...
  function testRootAction() {
    ...
    $form = new SimpleForm($tag, $page);
    $this->assertEqual(
      $form->getAction(), new SimpleUrl('http://host/'));
  }
  ...
  function testSubmitButton() {
    ...
    $this->assertEqual(
      $form->submitButton(new SimpleByName('go')), new SimpleGetEncoding(array('go' => 'Go!')));
    $this->assertEqual(
      $form->submitButton(new SimpleByLabel('Go!')), new SimpleGetEncoding(array('go' => 'Go!')));
    $this->assertEqual(
      $form->submitButton(new SimpleById(9)), new SimpleGetEncoding(array('go' => 'Go!')));
  }
  ...
  function testSubmitWithAdditionalParameters() {
    ...
    $this->assertEqual(
      $form->submitButton(new SimpleByLabel('Go!'), array('a' => 'A')), new SimpleGetEncoding(array('go' => 'Go!', 'a' => 'A')));
  }
  ...
  function testSubmitButtonWithLabelOfSubmit() {
    ...
    $this->assertEqual(
      $form->submitButton(new SimpleByName('test')), new SimpleGetEncoding(array('test' => 'Submit')));
    $this->assertEqual(
      $form->submitButton(new SimpleByLabel('Submit')), new SimpleGetEncoding(array('test' => 'Submit')));
  }
  ...
  function testImageSubmitButton() {
    ...
    $this->assertEqual(
      $form->submitImage(new SimpleByLabel('Go!'), 100, 101), new SimpleGetEncoding(array('go.x' => 100, 'go.y' => 101)));
    $this->assertTrue($form->hasImage(new SimpleByName('go')));
    $this->assertEqual(
      $form->submitImage(new SimpleByName('go'), 100, 101), new SimpleGetEncoding(array('go.x' => 100, 'go.y' => 101)));
    $this->assertTrue($form->hasImage(new SimpleById(9)));
    $this->assertEqual(
      $form->submitImage(new SimpleById(9), 100, 101), new SimpleGetEncoding(array('go.x' => 100, 'go.y' => 101)));
  }
  ...
  function testImageSubmitButtonWithAdditionalData() {
    ...
    $form->addWidget(new SimpleImageSubmitTag(array(
      ...
      'alt' => 'Go!')));
    $this->assertEqual(
      $form->submitImage(new SimpleByLabel('Go!'), 100, 101, array('a' => 'A')), new SimpleGetEncoding(array('go.x' => 100, 'go.y' => 101, 'a' => 'A')));
  }
  ...
  function testSingleSelectFieldSubmitted() {
    ...
    $this->assertIdentical(
      $form->submit(), new SimpleGetEncoding(array('a' => 'aaa')));
  }
  ...
  function testSingleSelectFieldSubmittedWithPost() {
    ...
    $form->addWidget($select);
    $this->assertIdentical(
      $form->submit(), new SimplePostEncoding(array('a' => 'aaa')));
  }
