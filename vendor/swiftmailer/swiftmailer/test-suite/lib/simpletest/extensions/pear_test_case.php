...
class PHPUnit_TestCase extends SimpleTestCase {
  ...
  function assertSame($first, $second, $message = "%s") {
    ...
    return $this->assert(
        new TrueExpectation(), SimpleTestCompatibility::isReference($first, $second), $message);
  }
  ...
  function assertNotSame($first, $second, $message = "%s") {
    ...
    return $this->assert(
        new falseExpectation(), SimpleTestCompatibility::isReference($first, $second), $message);
  }
