...
class Swift_StreamFilters_StringReplacementFilterFactoryTest extends Swift_Tests_SwiftUnitTestCase {

  public function testInstancesOfStringReplacementFilterAreCreated() {
    $factory = $this->_createFactory();
    $this->assertIsA($factory->createFilter('a', 'b'), 'Swift_StreamFilters_StringReplacementFilter'
    );
  }
  ...
  public function testDifferingInstancesAreNotCached() {
    ...
    $this->assertNotEqual($filter1, $filter2, '%s: Differing instances should not be cached'
    );
  }
