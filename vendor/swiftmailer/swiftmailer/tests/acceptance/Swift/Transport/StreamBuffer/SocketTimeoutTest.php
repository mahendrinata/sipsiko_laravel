...
class Swift_Transport_StreamBuffer_SocketTimeoutTest extends Swift_Tests_SwiftUnitTestCase {
  ...
  public function skip() {
    ...
    $this->skipUnless(SWIFT_SMTP_HOST, 'Cannot run test without an SMTP host to connect to (define ' .
