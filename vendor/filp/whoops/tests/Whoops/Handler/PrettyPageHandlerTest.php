...
class PrettyPageHandlerTest extends TestCase {
  ...
  public function testSetEditorSimple() {
    ...
    $this->assertEquals(
      $handler->getEditorHref('/foo/bar.php', 10), 'subl://open?url=file://%2Ffoo%2Fbar.php&line=10'
    );

    $this->assertEquals(
      $handler->getEditorHref('/foo/with space?.php', 2324), 'subl://open?url=file://%2Ffoo%2Fwith%20space%3F.php&line=2324'
    );

    $this->assertEquals(
      $handler->getEditorHref('/foo/bar/with-dash.php', 0), 'subl://open?url=file://%2Ffoo%2Fbar%2Fwith-dash.php&line=0'
    );
  }
  ...
  public function testSetEditorCallable() {
    ...
    $this->assertEquals(
      $handler->getEditorHref('/foo/bar.php', 10), 'http://google.com/search/?q=%2Ffoo%2Fbar.php:10'
    );
  }
  ...
  public function testAddEditor() {
    ...
    $this->assertEquals(
      $handler->getEditorHref('hello', 20), 'cool beans hello:20'
    );
  }
  ...
  public function testEditorXdebug() {
    ...
    $this->assertEquals(
      '/foo/bar.php:10', $handler->getEditorHref('/foo/bar.php', 10)
    );
    ...
    $this->assertEquals(
      'subl://open?url=/foo/with space?.php&line=2324', $handler->getEditorHref('/foo/with space?.php', 2324)
    );
